...
namespace CP_LAB_5_LIB.LABs
{
    public class LAB3 : ILabWorker
    {
        ...
        private matrixNode AStar(char[,] matrix, int fromX, int fromY, int toX, int toY, int maxX, int maxY)
        {
        ...
        private string GetOutput(string Input)
        {
            ...
            result="The shortest path from {tY} {tX}  to {y - 2} {x - 2} is:";
            result+=tigerPath.Count;
            ...
            count = path.Count;
            result += "The shortest path from {1} {1}  to {y - 2} {x - 2} is:";
            result += path.Count;
