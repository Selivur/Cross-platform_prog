string[] lines = System.IO.File.ReadAllLines
        (@"C:\Users\si010\source\repos\cross-platform1\INPUT.txt");
int[] arr = { 0 };
int l=0;
int count;
try
...
File.WriteAllText(@"C:\Users\si010\source\repos\cross-platform1\OUTPUT.txt", Convert.ToString(arr.Length));